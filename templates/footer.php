...
<div class="container-fluid text-center text-md-left">
  ...
  <div class="row">
    ...
    <!-- Grid column -->
    <div class="description col-md-8 mt-md-0 mt-3">
      ...
      <div class="icons">
        ...
        <a target="_blank" title="Twitter" href="https://www.twitter.com/"><i class="fa fa-twitter"></i></a>
      </div>
    ...
    <!-- Grid column -->
    <div class="contact col-md-4 mb-md-0 mb-3">

      <!-- Content -->
      <h5 class="text-uppercase">Contact</h5>
      <div>
        <i class="fa fa-map-marker"></i>
        <p><span> 7 Cité Paradis</span> 75010 Paris, France</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p><a href="#"> jeanforteroche@mail.com</a></p>
      </div>
    </div>
    <!-- Grid column -->
