...
foreach ($articles as $article)
        {
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <hr>
                    <div class="info">
                        <p><span class="italic">écrit par </span> : <?= htmlspecialchars($article->getAuthor());?> | <span class="italic">posté le</span> : <i class="far fa-clock"></i> <?= htmlspecialchars($article->getCreatedAt());?></p>
                    </div>   
                    <div class="content">
